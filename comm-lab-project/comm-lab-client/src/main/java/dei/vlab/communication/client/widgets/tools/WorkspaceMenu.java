...
public class WorkspaceMenu {
	...
	public ToolStrip createMenu(ClickHandler clickHandler) {
	...
	private ToolStripMenuButton createHelpMenu(MenuItemSeparator separator) {
		...
		helpMenu.setItems(welcomeItem, separator, contentsItem, searchItem,
				separator, aboutItem);
	...
	private ToolStripMenuButton getRunMenu() {
		...
		runMenu.setItems(executeItem, simulateItem, viewLogItem,
				verifyCircuitItem);
	...
	private ToolStripMenuButton createEditMenu(MenuItemSeparator separator) {
		...
		editMenu.setItems(undoItem, redoItem, separator, copyItem, cutItem,
				pasteItem);
	...
	private ToolStripMenuButton createActivityMenu(MenuItemSeparator separator) {
		...
		newItem.addClickHandler(this.clickHandler);
		...
		activityMenu.setItems(newItem, openItem, separator, saveItem,
				saveAsItem, separator, recentItem);
		ToolStripMenuButton activityButton = new ToolStripMenuButton(ACTIVITY,
				activityMenu);
