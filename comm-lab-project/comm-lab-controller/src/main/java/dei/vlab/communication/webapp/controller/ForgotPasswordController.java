...
import dei.vlab.communication.service.MailEngine;
...
public class ForgotPasswordController {
    ...
    public @ResponseBody String handleRequest(HttpServletRequest request)
    throws Exception {
        ...
        try {
            ...
            saveMessage(request, text.getMessage("login.passwordHint.sent", new Object[] { username, user.getUserDetail().getEmail() }));
